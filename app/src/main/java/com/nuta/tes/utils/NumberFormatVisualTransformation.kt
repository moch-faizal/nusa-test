...
class NumberFormatVisualTransformation(
    ...
    private val withDecimals: Boolean = false,
    private val separator: String = DecimalFormat().decimalFormatSymbols.groupingSeparator.toString()
    ...
    override fun filter(text: AnnotatedString): TransformedText {
        ...
        val formattedNumber =
            if (withDecimals) intPart + decimalSeparator + fractionPart else intPart
